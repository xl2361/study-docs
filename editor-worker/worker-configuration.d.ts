/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=editor-worker/wrangler.jsonc editor-worker/worker-configuration.d.ts` (hash: fe88fe33f4bf204607f47229e7432578)
// Runtime types generated with workerd@1.20260722.1 2026-08-04 
interface __BaseEnv_Env {
	LOGIN_RATE_LIMITER: RateLimit;
	ALLOWED_ORIGIN: "https://dayu-study.pages.dev";
	GITHUB_OWNER: "xl2361";
	GITHUB_REPO: "study-docs";
