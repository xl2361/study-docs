...
const ICONS: Record<string, string> = {
	...
	strikethrough: `<path d="M18.5 6C16 4.2 12.8 4.2 10.8 5.8C8.6 7.6 9 10.2 12 12C15 13.8 15.4 16.4 13.2 18.2C11.2 19.8 8 19.8 5.5 18" stroke-width="2"/><path d="M5.5 12H18.5" stroke-width="1.7"/>`,
