...
<style>
 ...
 :global(.tiptap-host .ProseMirror td.selectedCell), :global(.tiptap-host .ProseMirror th.selectedCell) { background: #d3e4ff !important; }
  ...
  .tiptap-host :global(.ProseMirror pre code .hljs-number), .tiptap-host :global(.ProseMirror pre code .hljs-literal), .tiptap-host :global(.ProseMirror pre code .hljs-attr), .tiptap-host :global(.ProseMirror pre code .hljs-attribute), .tiptap-host :global(.ProseMirror pre code .hljs-meta), .tiptap-host :global(.ProseMirror pre code .hljs-operator), .tiptap-host :global(.ProseMirror pre code .hljs-selector-attr), .tiptap-host :global(.ProseMirror pre code .hljs-selector-class), .tiptap-host :global(.ProseMirror pre code .hljs-selector-id), .tiptap-host :global(.ProseMirror pre code .hljs-variable) { color: #79c0ff; }
  .tiptap-host :global(.ProseMirror pre code .hljs-title), .tiptap-host :global(.ProseMirror pre code .hljs-title-class_), .tiptap-host :global(.ProseMirror pre code .hljs-title-function_), .tiptap-host :global(.ProseMirror pre code .hljs-function) { color: #d2a8ff; }
  .tiptap-host :global(.ProseMirror pre code .hljs-built_in), .tiptap-host :global(.ProseMirror pre code .hljs-symbol), .tiptap-host :global(.ProseMirror pre code .hljs-bullet), .tiptap-host :global(.ProseMirror pre code .hljs-section), .tiptap-host :global(.ProseMirror pre code .hljs-params), .tiptap-host :global(.ProseMirror pre code .hljs-class) { color: #ffa657; }
  .tiptap-host :global(.ProseMirror pre code .hljs-name), .tiptap-host :global(.ProseMirror pre code .hljs-selector-pseudo) { color: #7ee787; }
  .tiptap-host :global(.ProseMirror pre code .hljs-tag) { color: #7ee787; }
  .tiptap-host :global(.ProseMirror pre code .hljs-link) { color: #79c0ff; }
  ...
  .tiptap-host :global(.ProseMirror pre code .hljs-addition) { color: #aff5b4; background-color: #033a16; }
  .tiptap-host :global(.ProseMirror pre code .hljs-deletion) { color: #ffdcd7; background-color: #67060c; }
  .tiptap-host :global(.ProseMirror pre code .hljs-subst) { color: #c9d1d9; }
  .tiptap-host :global(.ProseMirror pre code .hljs-punctuation) { color: #c9d1d9; }
