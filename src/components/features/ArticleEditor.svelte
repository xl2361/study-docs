...
<style>
 ...
 :global(.tiptap-host .ProseMirror td.selectedCell), :global(.tiptap-host .ProseMirror th.selectedCell) { background: #d3e4ff !important; }
  ...
  .tiptap-host :global(.ProseMirror pre code .ec-line-gutter) { position: absolute; left: 0; top: 0; width: 2.2rem; padding-top: 1rem; padding-right: .5rem; text-align: right; box-sizing: border-box; color: #8a8a8c; background: transparent; font-size: inherit; line-height: 1.5rem; user-select: none; -webkit-user-select: none; pointer-events: none; }
  .tiptap-host :global(.ProseMirror pre code .ec-line-gutter span) { display: block; height: 1.5rem; line-height: 1.5rem; }
  ...
  .tiptap-host :global(.ProseMirror pre code .hljs-number), .tiptap-host :global(.ProseMirror pre code .hljs-literal) { color: #875d01; }
  .tiptap-host :global(.ProseMirror pre code .hljs-title), .tiptap-host :global(.ProseMirror pre code .hljs-title-class_), .tiptap-host :global(.ProseMirror pre code .hljs-title-function_), .tiptap-host :global(.ProseMirror pre code .hljs-function) { color: #3360c1; }
  .tiptap-host :global(.ProseMirror pre code .hljs-type), .tiptap-host :global(.ProseMirror pre code .hljs-class), .tiptap-host :global(.ProseMirror pre code .hljs-built_in) { color: #885d01; }
  .tiptap-host :global(.ProseMirror pre code .hljs-attr), .tiptap-host :global(.ProseMirror pre code .hljs-attribute), .tiptap-host :global(.ProseMirror pre code .hljs-meta) { color: #a626a4; }
  .tiptap-host :global(.ProseMirror pre code .hljs-variable), .tiptap-host :global(.ProseMirror pre code .hljs-template-variable) { color: #af4238; }
  .tiptap-host :global(.ProseMirror pre code .hljs-operator), .tiptap-host :global(.ProseMirror pre code .hljs-punctuation), .tiptap-host :global(.ProseMirror pre code .hljs-subst) { color: #383a42; }
  .tiptap-host :global(.ProseMirror pre code .hljs-symbol), .tiptap-host :global(.ProseMirror pre code .hljs-bullet), .tiptap-host :global(.ProseMirror pre code .hljs-section), .tiptap-host :global(.ProseMirror pre code .hljs-params) { color: #885d01; }
  .tiptap-host :global(.ProseMirror pre code .hljs-name), .tiptap-host :global(.ProseMirror pre code .hljs-selector-pseudo), .tiptap-host :global(.ProseMirror pre code .hljs-tag) { color: #7f7f7f; }
  .tiptap-host :global(.ProseMirror pre code .hljs-link) { color: #3360c1; }
  ...
  .tiptap-host :global(.ProseMirror pre code .hljs-addition) { color: #387138; }
  .tiptap-host :global(.ProseMirror pre code .hljs-deletion) { color: #af4238; }
  :global(:root.dark) .tiptap-host :global(.ProseMirror pre code .hljs-comment), :global(:root.dark) .tiptap-host :global(.ProseMirror pre code .hljs-quote) { color: #9fa3aa; font-style: italic; }
  :global(:root.dark) .tiptap-host :global(.ProseMirror pre code .hljs-keyword), :global(:root.dark) .tiptap-host :global(.ProseMirror pre code .hljs-selector-tag), :global(:root.dark) .tiptap-host :global(.ProseMirror pre code .hljs-doctag), :global(:root.dark) .tiptap-host :global(.ProseMirror pre code .hljs-template-tag) { color: #cd89e1; }
  :global(:root.dark) .tiptap-host :global(.ProseMirror pre code .hljs-string), :global(:root.dark) .tiptap-host :global(.ProseMirror pre code .hljs-regexp), :global(:root.dark) .tiptap-host :global(.ProseMirror pre code .hljs-char) { color: #98c379; }
  :global(:root.dark) .tiptap-host :global(.ProseMirror pre code .hljs-number), :global(:root.dark) .tiptap-host :global(.ProseMirror pre code .hljs-literal) { color: #d19a66; }
  :global(:root.dark) .tiptap-host :global(.ProseMirror pre code .hljs-title), :global(:root.dark) .tiptap-host :global(.ProseMirror pre code .hljs-title-class_), :global(:root.dark) .tiptap-host :global(.ProseMirror pre code .hljs-title-function_), :global(:root.dark) .tiptap-host :global(.ProseMirror pre code .hljs-function) { color: #61afef; }
  :global(:root.dark) .tiptap-host :global(.ProseMirror pre code .hljs-type), :global(:root.dark) .tiptap-host :global(.ProseMirror pre code .hljs-class), :global(:root.dark) .tiptap-host :global(.ProseMirror pre code .hljs-built_in) { color: #e5c07b; }
  :global(:root.dark) .tiptap-host :global(.ProseMirror pre code .hljs-attr), :global(:root.dark) .tiptap-host :global(.ProseMirror pre code .hljs-attribute), :global(:root.dark) .tiptap-host :global(.ProseMirror pre code .hljs-meta) { color: #e5c07b; }
  :global(:root.dark) .tiptap-host :global(.ProseMirror pre code .hljs-variable), :global(:root.dark) .tiptap-host :global(.ProseMirror pre code .hljs-template-variable) { color: #e5c07b; }
  :global(:root.dark) .tiptap-host :global(.ProseMirror pre code .hljs-operator), :global(:root.dark) .tiptap-host :global(.ProseMirror pre code .hljs-punctuation), :global(:root.dark) .tiptap-host :global(.ProseMirror pre code .hljs-subst) { color: #abb2bf; }
  :global(:root.dark) .tiptap-host :global(.ProseMirror pre code .hljs-symbol), :global(:root.dark) .tiptap-host :global(.ProseMirror pre code .hljs-bullet), :global(:root.dark) .tiptap-host :global(.ProseMirror pre code .hljs-section), :global(:root.dark) .tiptap-host :global(.ProseMirror pre code .hljs-params) { color: #e5c07b; }
  :global(:root.dark) .tiptap-host :global(.ProseMirror pre code .hljs-name), :global(:root.dark) .tiptap-host :global(.ProseMirror pre code .hljs-selector-pseudo), :global(:root.dark) .tiptap-host :global(.ProseMirror pre code .hljs-tag) { color: #e06c75; }
