...
<style>
 ...
 :global(.tiptap-host .ProseMirror td.selectedCell), :global(.tiptap-host .ProseMirror th.selectedCell) { background: #d3e4ff !important; }
  ...
  .tiptap-host :global(.ProseMirror pre code) { font-family: inherit; font-size: inherit; line-height: inherit; color: inherit; background: none; padding: 0; }
