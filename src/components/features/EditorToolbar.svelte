...
const ICONS: Record<string, string> = {
	...
	strikethrough: `<path d="M18.5 6C16.3 4.2 13.2 4.2 11 5.7C8.6 7.4 8.9 10.2 12 12C15.1 13.8 15.4 16.6 12.9 18.1C10.4 19.6 7.2 19.3 5.7 17.3" stroke-width="2"/><path d="M5.7 12H18.5" stroke-width="1.7"/>`,
